        ...
        <div className="min-h-screen flex items-center justify-center bg-white px-4 py-8 sm:py-12 md:py-16 relative overflow-hidden font-sans selection:bg-emerald-100 selection:text-emerald-900">
            ...
            <div className="w-full max-w-md mx-auto bg-white p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-slate-100 relative z-10 transition-all hover:shadow-[0_30px_60px_rgba(0,0,0,0.06)]">
                <div className="text-center mb-6 sm:mb-8 md:mb-10">
                    ...
                    <h1 className="text-xl sm:text-2xl md:text-3xl font-bold font-heading text-slate-800 mb-2 tracking-tight">Access Your Portal</h1>
                    <p className="text-xs sm:text-sm md:text-base text-slate-500 font-medium">Welcome back to your coaching dashboard</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
                    ...
                    <div className="group">
                        <div className="flex justify-between items-center mb-1 sm:mb-1.5 ml-1">
                            <label className="text-xs sm:text-sm font-semibold font-heading text-slate-700 group-focus-within:text-emerald-600 transition-colors">
                                Password
                            </label>
                            <Link 
                                to="/forgot-password" 
                                name="forgot-password" 
                                className="text-xs sm:text-sm font-semibold text-emerald-600 hover:text-emerald-700 active:opacity-80 transition-colors"
                            >
                                Forgot Password?
                            </Link>
                        </div>
                    ...
                    >
                        {isLoading ? (
                            <>
                                ...
                                <span className="font-heading text-sm sm:text-base">Logging in...</span>
                            </>
                        ) : (
                            <>
                                <span className="font-heading text-sm sm:text-base">Login to Account</span>
                    ...
                    >
                        ...
                        <span className="font-heading text-sm sm:text-base">Sign in with Google</span>
                    </button>
                </form>
